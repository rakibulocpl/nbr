                           ...
                           :class="(selected === 'Profile') && (page === 'profile') ? 'menu-item-active' : 'menu-item-inactive'">
                            <svg
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round"
                                      d="M4 19V9m4 10V5m4 14v-7m4 7v-4m4 4V8"/>
                            </svg>
...
{{--                            <svg :class="(selected === 'Profile') && (page === 'profile')--}}
                        ...
                        <a href="{{ route('role.index') }}"
                           ...
                           : 'menu-item-inactive'">
                            ...
                            : 'menu-item-icon-inactive'"
                                 ...
                                 xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                      d="M17 20h5v-2a4 4 0 00-4-4h-1m-4 6H4v-2a4 4 0 014-4h1m7-8a4 4 0 11-8 0 4 4 0 018 0zm6 4a3 3 0 11-6 0 3 3 0 016 0z"/>
                            </svg>
