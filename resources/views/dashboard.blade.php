    ...
    <div class="max-w-7xl mx-auto p-6 space-y-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
            ...
            <div class="p-5 bg-gradient-to-br from-sky-500 to-sky-600 text-white rounded-2xl shadow hover:scale-[1.02] transition-transform duration-200">
                <h3 class="text-sm uppercase opacity-90">Total Requests</h3>
            ...
            @foreach ($statusCounts as $status => $count)
                @php
                    $colorMap = [
                        ...
                        'processing' => 'from-purple-500 to-fuchsia-600',
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-600 dark:text-gray-300">
                    ...
                    <tr>
                        ...
                        <th class="px-6 py-3">Business / Applicant Name</th>
                        <th class="px-6 py-3">TIN No</th>
                    ...
                    @forelse ($files as $index => $file)
                        @php
                            $statusName = $file->status ?? 'Unknown';
                        ...
                        <tr class="border-b dark:border-gray-800 hover:bg-sky-50 dark:hover:bg-sky-900/20 transition">
                            ...
                            <td class="px-6 py-4 font-semibold text-gray-800 dark:text-white">
                                {{ $file->taxpayer_name ?? 'N/A' }}
                            </td>
                            <td class="px-6 py-4 truncate max-w-[200px]">{{ $file->tin_no ?? 'N/A' }}</td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('analysis.show', $file->id) }}"
                                   class="px-4 py-1 bg-blue-600 text-white text-xs rounded hover:bg-blue-700">
                                    Preview
                                </a>
                            </td>
                        </tr>
