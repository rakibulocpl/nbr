                        ...
                        <form class="jquery_form_validation" method="POST" action="{{ route('user.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="space-y-3 border-t border-gray-100 p-4 sm:p-3 dark:border-gray-800 text-left">
                                ...
                                <div>
                                    ...
                                    <textarea name="address" rows="3" placeholder="Full address" class="dark:bg-dark-900 required shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"></textarea>
                                </div>
